...
<div id="pre-header" class="clearfix">
    <div class="container">
        ...
        <div id="pre-header-inside" class="clearfix">
            <div class="row">
                <div class="col-md-4">
                    <?php if (isset($page['pre_header_first'])):?>
                ...
                <div class="col-md-4">
                    <?php if (isset($page['pre_header_second'])):?>
                    <div class="pre-header-area">
                ...
                <div class="col-md-4">
                    <?php if (isset($page['pre_header_third'])):?>
                    <div class="pre-header-area">
    ...
    <div class="container">
        ...
        <div id="header-inside" class="clearfix">
            <div class="row">
                <div class="col-md-12">
				  <!-- #header-phones -->
				 <?php if (isset($page['header-phones'])):?>
                    <div class="header-phones">
                    <?php print render($page['header-phones']); ?>
                    </div>
                    <?php endif; ?>
				  <!-- #end header-phones -->
...
<div id="page" class="clearfix">
    ...
    <div id="top-content" class="clearfix">
				...
				<!--#after-navigation -->
		<div id="after-navigation" class="my-clearfix">
			<div class="rows">
				<div class="col-md-3">
                    <?php if ($page['after-navigation-first']):?>
                    <div class="mainpage-about">
                    <?php print render($page['after-navigation-first']); ?>
                    </div>
                    <?php endif; ?>
                </div>
                
                <div class="col-md-3">
                    <?php if ($page['after-navigation-second']):?>
                    <div class="mainpage-about">
                    <?php print render($page['after-navigation-second']); ?>
                    </div>
                    <?php endif; ?>
                </div>

                <div class="col-md-3">
                    <?php if ($page['after-navigation-third']):?>
                    <div class="mainpage-about">
                    <?php print render($page['after-navigation-third']); ?>
                    </div>
                    <?php endif; ?>
                </div>
			</div>
